...
namespace CollisionFloatTestNewMono.Engine
{
    ...
    public static class Primitives2D
    {
        ...
        {
            FillRectangle(spriteBatch, location, size, color, 0f);
        }
        ...
        {
            DrawRectangle(spriteBatch, rect, color, 1f);
        }
        ...
        public static void DrawRectangle(this SpriteBatch spriteBatch, Rectangle rect, Color color, float thickness)
        {
            ...
            DrawLine(spriteBatch, new Vector2(rect.X, rect.Bottom - 1f), new Vector2(rect.Right, rect.Bottom - 1f), color, thickness); // bottom
            DrawLine(spriteBatch, new Vector2(rect.Right, rect.Y - 1f), new Vector2(rect.Right, rect.Bottom - 1f), color, thickness); // right
        }
        ...
        {
            DrawLine(spriteBatch, point, length, angle, color, 1f);
        }
